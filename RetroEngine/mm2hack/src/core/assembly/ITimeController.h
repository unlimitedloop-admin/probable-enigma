...
{
    /// Abstract interface for time control.
    /// Corresponds to Fixed Delta and Step One Frame during pause.
    /// In a typical game loop, BeginFrame() -> DeltaSeconds() is passed to the game Update -> EndFrame() is called.
